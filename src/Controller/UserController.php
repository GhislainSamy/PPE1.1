...
/**
     * @Route(" /userad/{idAdherent}/infosup_edit", name="infosup_edit")
     */
    ...
    /**
     * @Route("/userad/{idAdherent}", name="adherent_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/userad/{idAdherent}/edit", name="adherent_edit", methods={"GET","POST"})
     */
...
/**
     * @Route("/userad/{idAdherent}/show", name="infosup_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/userad/{idAdherent}", name="adherent_delete", methods={"DELETE"})
     */
